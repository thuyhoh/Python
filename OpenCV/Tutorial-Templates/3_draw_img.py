...
cv2.line(img, (0,0), (255,255), (255,0,0), 5)# draw a blue line stat in point(0,0) and end in poitn (255,255) 
# cv2.line("nameimg","start_point","end_point","color(b,g,r)",'thik_of_line')

cv2.arrowedLine(img, (99,56), (255,255), (0,255,0), 5)# draw a gren arrowedline stat in point(0,0) and end in poitn (255,255) 

# draw a rectangle
cv2.rectangle(img,(300,100),(78,67),(0,0,255),7)# draw a red rectangel 
...
# draw a circle
cv2.circle(img,(300,250),63,(20,50,200),8)
# cv2.circle("name_img","center_point","r",...)

# text
font = cv2.FONT_HERSHEY_DUPLEX # choice font of tex( hershey duplex)
cv2.putText(img,"new note",(10,500),font,4,(123,9,78),10,cv2.LINE_AA)
